<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 back-sky">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center text-xl subpixel-antialiased font-bold text-red">
                        {{ __('塾講師専門アプリ') }}
                </div>
            ...
            <!-- Hamburger -->
            <div class="-mr-2 flex items-center sm:hidden back-sky">
